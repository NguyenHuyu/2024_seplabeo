  ...
  return (
    <div>
      <section className='bg-white dark:bg-gray-900'>
        <div className='mx-auto grid items-center max-w-screen-2xl px-4 py-4 text-center'>
          <div className='mx-auto place-self-center space-y-8'>
            <div className='flex justify-between items-center'>
              <div className='w-full sm:w-1/2'>
                <Image
                  ...
                  width={1000}
                  height={1000}
                  className='w-full h-96 object-contain rounded-lg sm:h-52 '
                />
              </div>
              <h1 className='mb-4 max-w-3xl text-4xl font-extrabold leading-none tracking-tight text-red-700 md:text-5xl xl:text-6xl animation-container-down'>
            ...
            <div className='flex items-center justify-between'>
              <div className='text-sm leading-6 col-start-1 sm:col-span-2 lg:row-start-4 lg:col-span-1 dark:text-slate-400  animation-container-left-right'>
                <strong>
                  <p className='font-extrabold md:text-lg md:mt-3 lg:mb-4 md:px-2 text-black'>
                    {cordyceps.cordyceps_bold}
                  </p>
                </strong>
                {cordyceps.cordyceps_title.map((item, index) => (
                  <p className='leading-normal md:text-md mb-4 md:mb-2 px-2' key={index}>
                    {item}
                  </p>
                ))}
              </div>
            ...
            <Link href={`/${params.language}/lien-he`} className='mt-4'>
      ...
      <section className='bg-white py-4 md:py-8 mx-auto'>
        <div className='container max-w-5xl mx-auto '>
          <h1 className='w-full my-2 text-5xl leading-tight text-center text-[#bf1f2f] font-bold'>
            {cordyceps.intro}
          </h1>
      ...
      <section className='bg-gray-100 py-8'>
        <div className='max-w-4xl mx-auto px-2 pt-4 pb-12 text-gray-800 '>
          ...
          <iframe
            className='w-full'
            height='300'
            src='https://www.youtube.com/embed/vEPr1Cg1B5M'
            title='Lễ hội "Nông sản đặc sản vùng miền 2023” với nhiều đặc sản cải thiện sức khoẻ con người'
