...
import ImageA3 from '@/public/a3.png'
...
export default async function page({ params }: PageProps) {
  const { bakery } = await getDictionary(params.language)

  return (
    <section className='bg-white min-h-screen'>
      <div className='container flex flex-col mx-auto bg-white'>
        <div className='grid w-full grid-cols-1 my-auto mt-12 mb-8 md:grid-cols-2'>
          <div className='flex flex-col justify-center col-span-1 text-center lg:text-start'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-2 gap-4 items-start justify-center '>
              {bakery.descriptions.map((item, index) => (
                <li
                  key={index}
